...
DATABASES = {
    'default': {
        ...
        'NAME': 'menpha',
        #'NAME': os.path.join(SITE_ROOT, ''),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&7)&i1d+^%1_4)b(*x&4uuy*$#g3qw0z54zn6(n880c5o46mcg'
...
#Using default via .FallbackStorage
#MESSAGE_STORAGE = 'django.contrib.messages.storage.session.SessionStorage'

ROOT_URLCONF = 'Menpha.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Menpha.wsgi.application'
...
# Needed by Registration App
ACCOUNT_ACTIVATION_DAYS = 2

# Example for using Gmail as email sending backend
EMAIL_USE_TLS = True
